...
const source = path.join(
  root,
  "piton-docs/social-production/ad-video-v1/creative-story.html",
);
const output = path.join(root, "public/assets/social/ad-video-v1");
const frames = path.join(output, ".frames");
const video = path.join(output, "piton-performance-ad-story-12s.mp4");
const poster = path.join(output, "piton-performance-ad-story-poster.jpg");
