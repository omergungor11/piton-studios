...
<BlogFigure name="website-redesign-seo-migration" alt="Yönlendirme haritası: soldaki eski adresler sağdaki yeni adreslere bire bir bağlanıyor; iki eski adres tek yeni adreste birleşiyor, karşılığı olmayan adres işaretli." caption="Her eski adresin bir kararı olmalı: taşı, birleştir ya da bilerek kapat — karar verilmeyen adresler yayından sonra kayıp trafiğe dönüşür." />
