...
<BlogFigure name="accessible-web-design-forms" alt="Form alanı anatomisi: yukarıdan aşağıya etiket, yardım metni, görünür odak halkalı giriş alanı, simgeyle işaretlenmiş hata satırı ve geniş dokunma hedefi." caption="Sıra önemli: etiket alanın üstünde kalır, yardım metni alandan önce okunur, hata alanın hemen altında ve yalnızca renge dayanmadan verilir." />
