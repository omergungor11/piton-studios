...
export const WORKS: Work[] = [
  ...
  },
  {
    ...
    role: "Design / Development",
    collaborator: "Saiber",
    tags: ["WordPress", "Real Estate", "Listings", "SEO"],
    image: "story-05.jpg",
    summary: "Real estate listing website for a Bozüyük-based agency.",
    body: [
      "Lider Emlak için Bozüyük'teki portföyünü profesyonelce sergileyebileceği, ilanların kategorize edilip listelendiği bir emlak web sitesi geliştirdik. WordPress üzerinde özel tema ile markaya uygun bir tasarım kurduk.",
      "İlan yönetimi, konum bilgileri ve iletişim akışları tek panelden yönetilebilir hale geldi. Temel teknik SEO ile yerel aramalarda görünürlük sağlandı. Proje Saiber ortaklığıyla teslim edildi.",
    ],
  ...
  },
  {
    ...
    year: "2025",
    role: "Product / Development",
    tags: ["Next.js", "AI", "Matching", "Concept"],
    image: "story-01.jpg",
    summary: "AI-powered matching concept for a dating product, prototyped with Next.js.",
    body: [
      "Kullanıcı profillerini yapay zekâ ile analiz edip uyum bazlı eşleştirme öneren bir tanışma uygulaması konsepti geliştirdik. Next.js üzerinde kurulan prototip; profil akışı, eşleştirme mantığı ve öneri ekranlarını içeriyor.",
      "Ürün fikri aşamasındaki bu çalışma; AI destekli öneri sistemleri ve modern ürün prototipleme deneyimimizi gösteriyor.",
    ],
  ...
  },
  {
    ...
    kind: "AI Tool · Automation",
    year: "2025",
    role: "Product / Development",
    tags: ["Gemini API", "AI", "Tracking", "Automation"],
    image: "story-02.jpg",
    summary: "Gemini API-based tracking and monitoring tool prototype.",
    body: [
      "Gemini API'ını kullanarak içerik ve veri akışlarını izleyen, özetleyen ve raporlayan bir takip aracı prototipi geliştirdik. LLM tabanlı analiz ile ham veriden anlamlı özetler üretiliyor.",
