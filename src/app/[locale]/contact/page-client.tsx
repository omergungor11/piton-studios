  ...
  return (
    <PageShell>
      ...
      <div className="cp-info-cards">
        <a href="mailto:hi@pitonstudios.com" className="cp-info-card" data-cursor="hover" data-reveal="rise" style={{ '--i': 0 } as CSSProperties}>
        ...
        <a href="https://wa.me/905439500750" target="_blank" rel="noopener noreferrer" className="cp-info-card" data-cursor="hover" data-reveal="rise" style={{ '--i': 1 } as CSSProperties}>
          <div className="cp-info-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="cp-info-card" data-reveal="rise" style={{ '--i': 2 } as CSSProperties}>
          <div className="cp-info-icon">
      ...
      {/* Contact Form — form/input alanlari reveal ile animasyonlanmiyor */}
      <ContactScene />

      {/* CTA */}
      <section className="sp-cta glass strong" style={{ marginTop: 24 }} data-reveal="fade">
