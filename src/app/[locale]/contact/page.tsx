    ...
    <PageShell>
      ...
      <Reveal variant="fadeUp" delay={0.1}>
        <div className="cp-info-cards">
          ...
          <a href="https://wa.me/905000000000" target="_blank" rel="noopener noreferrer" className="cp-info-card" data-cursor="hover">
            <div className="cp-info-icon">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="cp-info-value">WhatsApp</div>
