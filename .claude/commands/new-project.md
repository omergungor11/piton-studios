...
**[PREFIX]-config/workflow.md**: Task workflow kurallari yaz.
**[PREFIX]-config/conventions.md**: Tech stack'e OZEL conventions yaz.
**[PREFIX]-config/tech-stack.md**: Secilen teknolojilerin versiyonlariyla doldur.
**[PREFIX]-config/agent-instructions.md**: Agent tipleri ve scope'lari yaz.

### 4.9: Docs

**[PREFIX]-docs/MEMORY.md**: Proje bilgileriyle doldur.
**[PREFIX]-docs/CHANGELOG.md**: Bos template.

### 4.10: CLAUDE.md

TAMAMEN OZELLESTIRILMIS ana konfigurasyon dosyasi yaz.
...
Tum dosyalar olusturulduktan sonra dogrula ve ozet ver.
